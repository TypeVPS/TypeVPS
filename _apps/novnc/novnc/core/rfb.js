...
import { typevpsParseServerMessage, typevpsSendAuthMessage, typevpsState } from '../typevps.js';
...
export default class RFB extends EventTargetMixin {
    ...
    _socketOpen() {
        ...
        if ((this._rfbConnectionState === 'connecting') &&
            ...
            typevpsSendAuthMessage(this._sock);
        } else {
    ...
    _handleMessage() {
        if(!typevpsState.isLoggedIn) {
            Log.Warn("not logged in");
            typevpsParseServerMessage(this._sock);
            // get message from websocket as string
